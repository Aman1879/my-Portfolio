        ...
        <div className="contact-info slide-in-left">
          ...
          <div className="follow-section">
            ...
            <div className="social-links">
              <a href="https://github.com/Aman1879" className="social-link" target="_blank" rel="noreferrer">
                <i className="fa-brands fa-github"></i>
              </a>
              <a href="https://www.linkedin.com/in/aman-kumar-singh-827631283/" className="social-link" target="_blank" rel="noreferrer">
